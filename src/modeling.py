...
def apply_model(training_data, test_data, training_labels, classifier):
...
def evaluate_model_from_training_data(training_data, training_labels, classifier):
    ...
    predictions = apply_model(training_subset, test_subset, training_labels_subset, classifier)
...
def sweep_decision_tree(training_data, training_labels):
    ...
    for max_depth in max_depth_values:
        for min_samples_leaf in min_samples_leaf_values:
            ...
            accuracy = evaluate_model_from_training_data(training_data, training_labels, classifier)

            print('DecisionTree', max_depth, min_samples_leaf, accuracy * 100)
...
def sweep_logistic_regression(training_data, training_labels):
    ...
    for c in c_values:
        ...
        print('LogisticRegression', c, accuracy * 100)
    ...
    for n_estimators in n_estimators_values:
        for max_depth in max_depth_values:
            for min_samples_split in min_samples_split_values:
                ...
                print('RandomForest', n_estimators, max_depth, min_samples_split, accuracy * 100)
    ...
    for n_estimators in n_estimators_values:
        for learning_rate in learning_rate_values:
            for base_max_depth in base_max_depth_values:
                ...
                print('AdaBoost', n_estimators, learning_rate, base_max_depth, accuracy * 100)
